  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        links: [["/beginner-guides/skill-score-stop", "스킬 점수 몇 점이면 멈춰도 될까"], ["/beginner-guides/skill-reroll-stop", "고스변권 몇 장 없을 때 목표 잡는 법"], ["/beginner-guides/hitter-skill-guide", "타자는 어느 정도에서 타협하면 될까"], ["/beginner-guides/pitcher-skill-guide", "선발과 불펜을 같은 기준으로 보면 안 되는 이유"]],
      },
      {

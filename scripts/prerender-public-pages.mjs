...
const pages = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: "먼저 올라갈 글",
        body: "계산기와 연결해서 바로 읽을 수 있는 기준 글을 먼저 정리했습니다.",
        links: [
          ["/skill-score-method", "스킬 점수 몇 점이면 멈춰도 될까"],
          ["/guides/skill-reroll-stop", "고스변권 몇 장 없을 때 목표 잡는 법"],
          ["/guides/hitter-skill-guide", "타자는 어느 정도에서 타협하면 될까"],
          ["/guides/pitcher-skill-guide", "선발과 불펜을 같은 기준으로 보면 안 되는 이유"],
          ["/guides/impact-skill-guide", "임팩트 1옵작 후 일스변은 어디까지 노릴까"],
          ["/guides/training-redistribution-guide", "훈련 재분배 확률은 어떻게 읽어야 할까"],
          ["/guides/lineup-ocr-checklist", "라인업 스킬 인식 전 무엇을 확인해야 할까"],
        ],
      },
      {
  ...
  },
  {
    ...
    description: "고급 스킬 변경권을 적게 보유했을 때 목표 등급, 기대 횟수, 멈출 기준을 잡는 방법입니다.",
    heading: "고스변권 몇 장 없을 때 목표 잡는 법",
    intro: "보유 변경권 수와 기대 횟수를 같이 보고 무리한 목표를 피하는 기준을 정리했습니다.",
    sections: [
      {
        title: "목표를 낮게 잡아야 하는 이유",
        body: "고급 스킬 변경권이 적을 때 처음부터 SR+나 SS만 보고 끝까지 돌리면 손실이 커질 수 있습니다. 기대 횟수는 평균 난이도이지 보장 횟수가 아니므로 보유권이 10장, 20장처럼 제한되어 있다면 실사용 가능한 조합을 먼저 확보하는 것이 안전합니다.",
      },
      {
        title: "보유권 수별 목표",
        body: "10장 이하는 현재보다 확실히 좋아지는 C~B 조합을 우선하고, 30장 전후는 B~A를 목표로 봅니다. 50장 이상이면 A 이상을 노릴 수 있고, 100장 이상이면 S 이상도 고려할 수 있지만 카드 가치와 교체 계획을 함께 봐야 합니다.",
      },
      {
        title: "멈출지 판단하는 순서",
        body: "현재 조합의 점수와 등급을 계산하고, 목표 등급의 기대 횟수가 보유권보다 몇 배 높은지 확인합니다. 주전 카드인지 임시 카드인지 구분하고, 실사용 가능한 스킬 2개 이상이 들어간 조합이면 저장 후보로 봅니다.",
      },
      {
        title: "계산기와 시뮬레이터 사용",
        body: "스킬 점수 계산기에서 현재 조합의 등급과 상위 확률을 보고, 고스변 시뮬에서 목표 등급을 바꿔가며 자동 롤을 여러 번 돌려봅니다. 한두 번의 결과보다 여러 실행에서 보이는 대략적인 구간을 참고하는 것이 좋습니다.",
      },
    ],
  },
  {
    path: "/guides/hitter-skill-guide",
    title: "타자 스킬 조합을 볼 때 체크할 기준 | CPBV LAB",
    description: "타자 카드에서 스킬 점수, 레벨, 카드 타입, 라인업 역할을 함께 보고 조합을 판단하는 기준입니다.",
    heading: "타자 스킬 조합을 볼 때 체크할 기준",
    intro: "타자 스킬은 총점뿐 아니라 카드 역할, 라인업 위치, 변경권 여유를 같이 봐야 합니다.",
    sections: [
      {
        title: "총점만 보면 부족합니다",
        body: "타자 스킬은 총점이 높아도 실제 카드 역할과 맞지 않으면 체감이 달라질 수 있습니다. 중심 타선에 둘 카드인지 후보 카드인지에 따라 멈출 기준도 달라집니다.",
      },
      {
        title: "입력 전 확인할 것",
        body: "카드 타입이 시그니처, 골든글러브, 국가대표, 임팩트 중 무엇인지 확인하고, 스킬 레벨을 실제 값 그대로 입력해야 합니다. 조건이 붙은 스킬은 실제 조건에 맞는 항목을 선택합니다.",
      },
      {
        title: "초보자가 잡기 쉬운 타협선",
        body: "주전 타자라면 현재보다 등급이 오르거나 핵심 스킬 2개 이상이 들어간 조합을 우선 후보로 둡니다. 후보 카드나 교체 예정 카드에는 높은 목표보다 사용 가능한 수준의 조합을 빠르게 확보하는 편이 낫습니다.",
      },
      {
        title: "라인업 평균과 같이 보기",
        body: "선수 한 명의 점수만 높아도 라인업 전체 평균이 낮으면 개선 우선순위가 달라질 수 있습니다. 라인업 스킬 인식으로 선수별 점수를 같이 보면 어느 카드부터 손봐야 하는지 정하기 쉽습니다.",
      },
    ],
  },
  {
    path: "/guides/pitcher-skill-guide",
    title: "선발·중계·마무리 스킬을 나눠 봐야 하는 이유 | CPBV LAB",
    description: "투수 스킬 계산에서 선발, 중계, 마무리를 분리해야 하는 이유와 입력 실수를 줄이는 방법입니다.",
    heading: "선발·중계·마무리 스킬을 나눠 봐야 하는 이유",
    intro: "투수는 실제 보직을 먼저 맞춰야 점수와 등급을 제대로 비교할 수 있습니다.",
    sections: [
      {
        title: "보직 선택이 먼저입니다",
        body: "투수 스킬은 선발, 중계, 마무리 기준이 다릅니다. 실제로 사용할 위치를 잘못 고르면 같은 스킬 조합도 전혀 다른 기준으로 표시됩니다.",
      },
      {
        title: "선발 카드에서 볼 것",
        body: "선발은 긴 이닝을 전제로 보기 때문에 안정적인 조합과 높은 점수의 균형이 중요합니다. 변경권이 적을 때는 최고점만 노리기보다 실사용 가능한 메이저 조합을 먼저 확보하는 쪽이 좋습니다.",
      },
      {
        title: "중계와 마무리를 따로 보는 이유",
        body: "중계와 마무리는 등장 상황이 다르고 특정 스킬의 가치도 다르게 느껴질 수 있습니다. 라인업 인식 결과에서도 포지션을 수정하면 선수별 점수가 다시 계산되므로 저장 전 보직을 확인해야 합니다.",
      },
      {
        title: "자주 하는 입력 실수",
        body: "선발 카드를 중계 기준으로 계산하거나 좌투·우투 조건 스킬을 반대로 고르는 경우가 많습니다. 레벨을 기본값으로 둔 채 실제 레벨을 입력하지 않는 실수도 자주 발생합니다.",
      },
    ],
  },
  {
    path: "/guides/impact-skill-guide",
    title: "임팩트 1옵작 후 일스변 목표 잡는 법 | CPBV LAB",
    description: "임팩트 카드에서 1번 스킬을 고정한 뒤 2번, 3번 스킬 변경 목표를 어떻게 잡을지 정리했습니다.",
    heading: "임팩트 1옵작 후 일스변 목표 잡는 법",
    intro: "임팩트는 1번을 고정한 뒤 2번과 3번의 목표를 따로 계산해야 합니다.",
    sections: [
      {
        title: "1번 포함 점수와 제외 점수",
        body: "임팩트 카드는 1번 스킬을 먼저 맞춘 뒤 2번과 3번을 바꾸는 경우가 많습니다. 총점만 보면 실제 변경 난이도를 오해할 수 있어 1번 포함 점수와 제외 점수를 나눠 봐야 합니다.",
      },
      {
        title: "일스변 목표 순서",
        body: "1번 고정 스킬이 유지할 만한지 확인하고, 2번과 3번에 필요한 메이저 조합 조건을 정합니다. 그다음 임팩트 변경 시뮬에서 목표까지의 반복 횟수를 여러 번 확인합니다.",
      },
      {
        title: "언제 멈추면 좋을까",
        body: "1번이 좋은 상태라면 2번과 3번에서 최고 조합만 노리기보다 실사용 가능한 2메이저 조합을 먼저 확보하는 것이 안전합니다. 교체 가능성이 큰 카드라면 변경권을 과하게 쓰지 않는 편이 좋습니다.",
      },
      {
        title: "시뮬 결과 주의점",
        body: "등장 횟수는 이번 실행에서 나온 반복 횟수입니다. 같은 조건으로 다시 돌리면 더 빠르거나 늦게 나올 수 있으므로 여러 번 돌렸을 때의 대략적인 구간과 기대 횟수를 함께 보세요.",
      },
    ],
  },
  {
    path: "/guides/training-redistribution-guide",
    title: "훈련 재분배 확률 계산 결과를 해석하는 법 | CPBV LAB",
    description: "파정선, 변구 합계와 카드 타입별 훈련 횟수 차이를 기준으로 훈련 재분배 결과를 읽는 방법입니다.",
    heading: "훈련 재분배 확률 계산 결과를 해석하는 법",
    intro: "타자는 파정선, 투수는 변구 합계를 기준으로 결과의 희귀도를 읽습니다.",
    sections: [
      {
        title: "무엇을 계산하나요",
        body: "훈련 재분배 확률 계산기는 타자에서는 파워, 정확, 선구 합계를 보고 투수에서는 변화, 구위 합계를 봅니다. 입력한 합계 이상이 나올 확률과 평균 시도 횟수를 함께 보여줍니다.",
      },
      {
        title: "카드 타입을 먼저 고르는 이유",
        body: "임팩트, 국가대표, 시그니처, 골든글러브, 올스타/라이브는 훈련 가능한 횟수와 조건이 다릅니다. 같은 합계라도 카드 타입에 따라 확률이 달라집니다.",
      },
      {
        title: "결과를 볼 때 기준",
        body: "상위 확률이 낮을수록 보기 어려운 결과이고, 기대 횟수는 평균 난이도입니다. 현재 카드가 오래 쓸 카드인지에 따라 목표 합계를 다르게 잡아야 합니다.",
      },
      {
        title: "실사용 판단",
        body: "결과가 희귀해 보여도 카드가 교체 예정이면 과하게 집착할 필요가 없습니다. 오래 쓸 핵심 카드라면 기대 횟수가 조금 높아도 도전할 가치가 있을 수 있습니다.",
      },
    ],
  },
  {
    path: "/guides/lineup-ocr-checklist",
    title: "라인업 스킬 인식 전 체크리스트 | CPBV LAB",
    description: "라인업 스킬 인식 정확도를 높이기 위해 캡처 전후로 확인해야 할 항목을 정리했습니다.",
    heading: "라인업 스킬 인식 전 체크리스트",
    intro: "캡처 품질과 저장 전 검수를 맞추면 이미지 인식 결과를 더 안정적으로 활용할 수 있습니다.",
    sections: [
      {
        title: "캡처 전에 확인할 것",
        body: "게임 해상도를 높음 또는 최고로 설정하고 선수명, 보직, 스킬 3개, 레벨 숫자가 모두 보이게 세로로 캡처합니다. 이미지를 자르거나 재압축하지 않은 원본 파일을 사용하는 것이 좋습니다.",
      },
      {
        title: "바로 저장하지 마세요",
        body: "이미지 인식은 입력을 빠르게 채워주는 기능이지 정답 확정 기능이 아닙니다. 선수명, 카드 타입, 포지션, 스킬명, 레벨을 저장 전에 한 번씩 확인해야 합니다.",
      },
      {
        title: "투수 라인업에서 자주 틀리는 부분",
        body: "투수는 선발, 중계, 마무리 보직에 따라 점수 기준이 달라집니다. 선발 좌투·우투 조건이나 중계/마무리 전환은 저장 전에 직접 확인하는 것이 좋습니다.",
      },
      {
        title: "결과 활용",
        body: "선수별 점수와 라인업 평균을 보면 어떤 카드부터 손봐야 할지 우선순위를 잡을 수 있습니다. 점수가 낮으면서 오래 쓸 카드부터 개선 계획을 세우면 효율적입니다.",
      },
    ],
  },
  {
...
function renderPageContent(page) {
  const links = [
    ...
    ["/guides/skill-reroll-stop", "고스변 목표"],
    ["/guides/hitter-skill-guide", "타자 스킬"],
    ["/guides/pitcher-skill-guide", "투수 스킬"],
    ["/guides/impact-skill-guide", "임팩트 스킬"],
    ["/guides/training-redistribution-guide", "훈재분 확률"],
    ["/guides/lineup-ocr-checklist", "인식 체크리스트"],
    ["/faq", "FAQ"],
    ["/privacy", "개인정보처리방침"],
    ["/terms", "이용약관"],
    ["/contact", "문의"],

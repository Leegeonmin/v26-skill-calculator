    ...
    sections: [
      {
        ...
        body: "OCR은 캡처 품질이 안 좋으면 바로 흔들립니다. 선수명, 스킬 3개, 레벨 숫자가 한 화면에 잘 보여야 하고, 위아래가 잘리면 첫 선수나 마지막 선수가 빠질 수 있습니다. PNG, JPG, JPEG, WEBP 파일을 올릴 수 있으며, 가능하면 자르거나 압축한 이미지보다 원본 캡처를 올리는 편이 낫습니다.",
        image: {
      ...
      {
        title: "업로드부터 결과 확인까지",
        body: "Google 로그인 후 투수 또는 타자 업로드를 선택하면 OCR이 먼저 선수 행과 스킬 칸을 찾아서 후보를 채웁니다. 다만 이 단계에서 바로 정답이라고 보면 안 됩니다. 선수명, 카드 타입, 보직, 스킬명, 레벨을 한 번씩 보고 틀린 값은 저장 전에 고쳐야 합니다.",
      },
      {
        title: "OCR 결과가 이상할 때 먼저 볼 것",
      ...
      },
      {
        ...
        body: "OCR은 정답을 확정하는 기능이 아니라 입력을 빠르게 채우는 기능입니다. 틀린 값을 고치면 점수도 바로 다시 계산됩니다. OCR 결과가 조금 틀려도 저장 전에만 제대로 고치면 계산기와 같은 기준으로 선수별 총점과 라인업 평균을 다시 볼 수 있습니다.",
      },
      {
        title: "사용 횟수와 저장되는 기록",
        body: "공개 OCR은 비용이 들어가는 기능이라 Google 로그인 후 제한을 두고 있습니다. 현재는 타자 1회, 투수 1회를 주간 기준으로 사용할 수 있습니다. 결과를 다시 열 수 있도록 파일명, OCR 응답, 사용자가 고친 선수·스킬 값, 총점과 평균 점수를 스냅샷으로 저장합니다.",
      },
      {
        title: "저장 전 스냅샷과 삭제",
        body: "OCR을 돌리면 검수용 스냅샷이 먼저 만들어집니다. 최종 저장 전이라도 결과를 다시 열어 확인할 수 있게 하려는 용도입니다. 필요 없으면 검수 화면에서 삭제할 수 있고, 저장한 기록이나 계정 관련 정보 삭제가 필요하면 문의 페이지 또는 이메일로 요청할 수 있습니다.",
      },
      {
      ...
      {
        title: "기능의 한계",
        body: "OCR은 화면 상태에 따라 결과가 꽤 달라질 수 있습니다. 해상도가 낮거나 이미지가 압축됐거나, 새 스킬 아이콘이 추가된 경우에는 인식률이 떨어질 수 있습니다. OCR 결과만 보고 게임 내 판단을 확정하지 말고, 반복해서 틀리는 항목이 있으면 원본 이미지와 함께 제보해주세요.",
      },
    ],
  },
  {

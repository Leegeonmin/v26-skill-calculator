    ...
    sections: [
      {
        ...
        body: (
          <>
            <p>
              OCR은 캡처 품질이 안 좋으면 바로 흔들립니다. 선수명, 스킬 3개, 레벨 숫자가 한 화면에
      ...
      },
      {
        ...
        body: (
          <p>
            Google 로그인 후 투수 또는 타자 업로드를 선택하면 OCR이 먼저 선수 행과 스킬 칸을 찾아서
      ...
      },
      {
        ...
        body: (
          <p>
            OCR은 정답을 확정하는 기능이 아니라 입력을 빠르게 채우는 기능입니다. 틀린 값을 고치면
            점수도 바로 다시 계산됩니다. OCR 결과가 조금 틀려도 저장 전에만 제대로 고치면 계산기와
      ...
      },
      {
        ...
        body: (
          <p>
            공개 OCR은 비용이 들어가는 기능이라 Google 로그인 후 제한을 두고 있습니다. 현재는 타자
            1회, 투수 1회를 주간 기준으로 사용할 수 있습니다. 결과를 다시 열 수 있도록 파일명, OCR
      ...
      },
      {
        ...
        body: (
          <p>
            OCR을 돌리면 검수용 스냅샷이 먼저 만들어집니다. 최종 저장 전이라도 결과를 다시 열어
      ...
      },
      {
        ...
        body: (
          <p>
            OCR은 화면 상태에 따라 결과가 꽤 달라질 수 있습니다. 해상도가 낮거나 이미지가 압축됐거나,
            새 스킬 아이콘이 추가된 경우에는 인식률이 떨어질 수 있습니다. OCR 결과만 보고 게임 내

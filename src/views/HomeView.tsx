...
export const NOTICE_ITEMS = [
  {
    date: "2026.09.16",
    title: "국가대표 훈련 재분배 기준 수정",
    body: "훈련 재분배 확률 계산기에서 국가대표 카드의 훈련 횟수를 20회에서 22회로 변경했습니다. 이에 따라 국가대표 카드의 총 분배 포인트와 상위 확률, 기대 횟수 계산이 최신 기준으로 반영됩니다.",
  },
  {
    date: "2026.09.16",
    title: "마무리 소방수 스킬 추가",
    body: "마무리 투수 전용 스킬 소방수를 점수표에 추가했습니다. 5~10레벨 점수는 각각 22.91, 25.31, 32.14, 38.98, 45.81, 52.65이며 계산기, 스킬 비교, 라인업 점수 계산에 반영됩니다.",
  },
  {
    date: "2026.09.10",
    title: "국가대표 타자 스킬 추가 및 컨택트히터 점수 수정",
    body: "국가대표 전용 타자 스킬 3종을 추가했습니다. 5/6레벨 점수는 빈틈없는타선(타순O) 17.93/23.83, 빈틈없는타선(타순X) 13.13/19.03, 국대 테이블세터 14.97/22.90입니다. 컨택트히터(타순배치O)의 5~10레벨 점수를 각각 12.20, 15.85, 18.25, 21.90, 24.30, 27.95로 수정했습니다.",
  },
  {
    date: "2026.08.28",

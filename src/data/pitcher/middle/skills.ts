...
const MIDDLE_SKILL_ROWS: MiddleSkillRow[] = [
  ...
  { id: "middle_skill_039", rawName: "부동심★1", score: { 5: 12.47, 6: 14.48, 7: 17.12, 8: 19.75 } },
  ...
  { id: "middle_skill_066", rawName: "처단수", score: { 5: 6.38, 6: 7.65, 7: 8.93, 8: 10.2 } },
  { id: "middle_skill_067", rawName: "승리의함성(추격조)", score: { 5: 6.32, 6: 7.56, 7: 8.8, 8: 10.04 } },
  { id: "middle_skill_068", rawName: "위닝샷★1", score: { 5: 4.64, 6: 7.45, 7: 7.82, 8: 8.18 } },
  ...
  { id: "middle_skill_083", rawName: "사고방지★2", score: { 5: 0, 6: 0, 7: 0, 8: 0 } },

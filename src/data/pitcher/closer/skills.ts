...
const CLOSER_SKILL_ROWS: CloserSkillRow[] = [
  { id: "closer_skill_001", rawName: "마당쇠(불펜)", score: { 5: 24.45, 6: 29.33, 7: 34.2, 8: 39.08 } },
  ...
  { id: "closer_skill_005", rawName: "저니맨", score: { 5: 16.07, 6: 20.51, 7: 24.94, 8: 29.38 } },
  { id: "closer_skill_006", rawName: "파이어볼", score: { 5: 17, 6: 20.23, 7: 23.45, 8: 26.68 } },
  ...
  { id: "closer_skill_059", rawName: "필승카드", score: { 5: 14.23, 6: 18.39, 7: 22.55, 8: 26.7 } },
  ...
  { id: "closer_skill_019", rawName: "워크에식(마무리)", score: { 5: 13.68, 6: 13.68, 7: 16.08, 8: 16.08 } },
  { id: "closer_skill_020", rawName: "도전정신(4성)", score: { 5: 13.8, 6: 16.2, 7: 18.6, 8: 21 } },
  ...
  { id: "closer_skill_032", rawName: "원포인트릴리프(셋업/마무리)", score: { 5: 10.85, 6: 12.67, 7: 14.48, 8: 16.3 } },
  { id: "closer_skill_033", rawName: "난세의영웅(불펜)", score: { 5: 6.24, 6: 9.41, 7: 10.18, 8: 13.34 } },
  ...
  { id: "closer_skill_060", rawName: "긴급투입(필승조/마무리)", score: { 5: 6.59, 6: 7.28, 7: 7.89, 8: 8.51 } },
  ...
  { id: "closer_skill_046", rawName: "타선지원", score: { 5: 4.5, 6: 5.4, 7: 6.3, 8: 7.2 } },
  { id: "closer_skill_047", rawName: "우타킬러(좌투)", score: { 5: 5.29, 6: 6.35, 7: 7.4, 8: 8.47 } },
  { id: "closer_skill_066", rawName: "우타킬러(우투)", score: { 5: 4.48, 6: 5.37, 7: 6.27, 8: 7.16 } },
  ...
  { id: "closer_skill_050", rawName: "좌타킬러(우투)", score: { 5: 3.66, 6: 4.4, 7: 5.13, 8: 5.86 } },
  { id: "closer_skill_067", rawName: "좌타킬러(좌투)", score: { 5: 2.85, 6: 3.42, 7: 3.99, 8: 4.55 } },
  { id: "closer_skill_051", rawName: "위기관리", score: { 5: 2.86, 6: 3.33, 7: 3.81, 8: 4.29 } },
  { id: "closer_skill_052", rawName: "변화구선호", score: { 5: 2.44, 6: 2.92, 7: 3.45, 8: 3.9 } },
  { id: "closer_skill_053", rawName: "기선제압(셋업/마무리)", score: { 5: 2.43, 6: 2.92, 7: 3.4, 8: 3.88 } },
  { id: "closer_skill_054", rawName: "더러운볼끝", score: { 5: 1.76, 6: 2.05, 7: 2.34, 8: 2.63 } },
